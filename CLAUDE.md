...
- **Known gaps** (see the doc's Backlog): the scraper only supports Shopify-based sites today; no admin promotion/audit UI for the scraper's category auto-resolution.
